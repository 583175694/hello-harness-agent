...
export const AGENT_PROTOCOL_LIMITS = {
  ...
  generatedWorkbookMaxCellCodePoints: 32_000,
...
export const AGENT_ERROR_CODES = {
  ...
  generatedFileRenderFailed: 'GENERATED_FILE_RENDER_FAILED',
  generatedFileRenderUnavailable: 'GENERATED_FILE_RENDER_UNAVAILABLE',
